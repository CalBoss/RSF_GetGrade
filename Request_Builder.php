		...
		$footer = "";
			if (!empty($_POST)){
				if(!empty($_POST['url']) && !empty($_POST['api_key'])){
					...
					echo "<!-- #header --><hr><div id=\"subheader\"><div id=\"url\"><a>URL: <font color=\"blue\"><strong>$wsdl</strong></font></a>";
					...
					echo "<div  id=\"content\"></br><p><strong>You must enter a value for each parameter: </strong></p>";
					echo "<form id=\"post-form\" method=\"POST\" action=\"GetGrade.php\">";
					echo "<div id=\"url\"><label for=\"fn\"><font color=\"blue\"><strong>user_id: </strong></font></label><input type=\"text\" ";
					echo "id=\"username\"name=\"username\" size=\"27\"/><a> case sensitive</a></div></br><div id=\"url\"><label for=\"ln\"><font ";
					echo "color=\"blue\"><strong>language: </strong></font></label><input type=\"text\" id=\"lc\" name=\"lan_code\"";
					echo "size=\"5\" /><a> case sensitive</a></div></br><div id=\"url\"><label for=\"lev\"><font color=\"blue\"><strong>language_level: ";
					echo "</strong></font></label><input type=\"text\" id=\"le\" name=\"level\"size=\"2\" /><a>(1-5)</a></div></br><div id=\"url\">";
